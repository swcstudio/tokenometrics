...
<critical>You MUST have already loaded and processed: {project-root}/.osx/bmm/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/.osx/bmm/workflows/workflow-status">
