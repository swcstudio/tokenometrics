...
1. Load relevant knowledge fragments from `{project-root}/.osx/bmm/testarch/tea-index.csv`:
...
- Traceability Matrix: `.osx/output/traceability-matrix.md`
- Test Design: `.osx/output/test-design-epic-2.md`
- Test Results: `ci-artifacts/test-report-2025-01-15.xml`
- NFR Assessment: `.osx/output/nfr-assessment-release-1.2.md`
```
...
1. **Update workflow status** (if `append_to_history: true`):
   ...
   - Format:
     ...
     - **Document**: [gate-decision-story-1.3.md](.osx/output/gate-decision-story-1.3.md)
...
2. **Generate stakeholder notification** (if `notify_stakeholders: true`):
   ...
   Full Report: .osx/output/gate-decision-story-1.3.md
   ```
