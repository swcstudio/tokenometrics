...
**Customization Directory:** `{project-root}/.osx/_cfg/agents/`
...
# {project-root}/.osx/_cfg/agents/{module}-{agent-name}.customize.yaml

# Example: .osx/_cfg/agents/bmm-pm.customize.yaml
```
