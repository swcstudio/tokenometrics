...
**Anti-pattern:** Adding `.osx/` to `.gitignore` breaks IDE tools, submodule management.
...
# Make personal customizations in .osx/
```
...
```bash
cd /path/to/your-project
# BMad available at ./.osx/, load agents normally
```
