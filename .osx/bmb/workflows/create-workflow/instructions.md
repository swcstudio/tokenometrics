...
<critical>The workflow execution engine is governed by: {project-root}/.osx/core/tasks/workflow.xml</critical>
<critical>You MUST have already loaded and processed: {project-root}/.osx/bmb/workflows/create-workflow/workflow.yaml</critical>
...
- Workflow: {project-root}/.osx/core/workflows/brainstorming/workflow.yaml
...
config_source: '{project-root}/.osx/{{target_module}}/config.yaml'
...
# Critical variables from config
config_source: '{project-root}/.osx/module/config.yaml'
output_folder: '{config_source}:output_folder'
user_name: '{config_source}:user_name'
communication_language: '{config_source}:communication_language'
date: system-generated
...
1. ALWAYS include critical headers:
   - Workflow engine reference: {project-root}/.osx/core/tasks/workflow.xml
...
4. Use proper XML tags from guide:
   ...
   - Output: <template-output>, <invoke-task halt="true">{project-root}/.osx/core/tasks/adv-elicit.xml</invoke-task>, <critical>, <example>
...
3. List ALL referenced files by scanning:
   ...
   **Critical: Workflow Dependencies**
   ...
   - Example: `<invoke-workflow>{project-root}/.osx/core/workflows/x/workflow.yaml</invoke-workflow>`
     → Add ".osx/core/workflows/x/workflow.yaml" to web_bundle_files
...
web_bundle:
  ...
  existing_workflows:
    - workflow_variable_name: '.osx/path/to/workflow.yaml'
```
...
web_bundle:
  ...
  author: 'BMad'
  instructions: '.osx/bmm/workflows/brainstorm-game/instructions.md'
  template: false
  web_bundle_files:
    - '.osx/bmm/workflows/brainstorm-game/instructions.md'
    - '.osx/mmm/workflows/brainstorm-game/game-context.md'
    - '.osx/core/workflows/brainstorming/workflow.yaml'
  existing_workflows:
    - core_brainstorming: '.osx/core/workflows/brainstorming/workflow.yaml'
```
