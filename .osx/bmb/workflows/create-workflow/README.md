...
`{project-root}/.osx/{{target_module}}/workflows/{{workflow_name}}/`
...
- Review `/.osx/bmb/workflows/create-workflow/workflow-creation-guide.md`
- Check existing workflows in `/.osx/bmm/workflows/` for examples
- Validate against `/.osx/bmb/workflows/create-workflow/checklist.md`
