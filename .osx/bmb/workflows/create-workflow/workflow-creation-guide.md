...
installed_path: '{project-root}/.osx/module/workflows/my-workflow'
...
<critical>The workflow execution engine is governed by: {project_root}/.osx/core/tasks/workflow.xml</critical>
...
| **Location**   | `/src/core/tasks/` | `/.osx/*/workflows/` |
...
# Paths
installed_path: '{project-root}/.osx/module/workflows/name'
...
- `<invoke-task halt="true">{project-root}/.osx/core/tasks/adv-elicit.xml</invoke-task>` - Trigger AI enhancement
...
<workflow>
  ...
  <step n="2" goal="Define requirements">
    ...
    <invoke-task halt="true">{project-root}/.osx/core/tasks/adv-elicit.xml</invoke-task>
  </step>
...
4. **Relative Paths**: Use `.osx/` root paths (no `{project-root}`)
...
web_bundle:
  ...
  # Core files (.osx/-relative paths)
  instructions: '.osx/module/workflows/workflow/instructions.md'
  validation: '.osx/module/workflows/workflow/checklist.md'
  template: '.osx/module/workflows/workflow/template.md'

  # Data files (no config_source allowed)
  data_file: '.osx/module/workflows/workflow/data.csv'

  # Complete file list - CRITICAL!
  web_bundle_files:
    - '.osx/module/workflows/workflow/instructions.md'
    - '.osx/module/workflows/workflow/checklist.md'
    - '.osx/module/workflows/workflow/template.md'
    - '.osx/module/workflows/workflow/data.csv'
...
1. **Remove Config Dependencies**:
   ...
   - Convert `{project-root}/.osx/` to `.osx/`
...
3. **Test Completeness**:
   ...
   - Verify all paths are relative to .osx/
...
web_bundle:
  ...
  instructions: '.osx/bmm/workflows/analyze-requirements/instructions.md'
  validation: '.osx/bmm/workflows/analyze-requirements/checklist.md'
  template: '.osx/bmm/workflows/analyze-requirements/template.md'

  # Data files
  techniques_data: '.osx/bmm/workflows/analyze-requirements/techniques.csv'
  patterns_data: '.osx/bmm/workflows/analyze-requirements/patterns.json'

  # Sub-workflow reference
  validation_workflow: '.osx/bmm/workflows/validate-requirements/workflow.yaml'

  standalone: true

  web_bundle_files:
    # Core workflow files
    - '.osx/bmm/workflows/analyze-requirements/instructions.md'
    - '.osx/bmm/workflows/analyze-requirements/checklist.md'
    - '.osx/bmm/workflows/analyze-requirements/template.md'

    # Data files
    - '.osx/bmm/workflows/analyze-requirements/techniques.csv'
    - '.osx/bmm/workflows/analyze-requirements/patterns.json'

    # Sub-workflow and its files
    - '.osx/bmm/workflows/validate-requirements/workflow.yaml'
    - '.osx/bmm/workflows/validate-requirements/instructions.md'
    - '.osx/bmm/workflows/validate-requirements/checklist.md'

    # Shared templates referenced in instructions
    - '.osx/bmm/templates/requirement-item.md'
    - '.osx/bmm/templates/validation-criteria.md'
```
...
- `/.osx/bmm/workflows/` - Production examples
