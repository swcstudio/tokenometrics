...
<critical>You MUST have already loaded and processed: {project-root}/.osx/bmb/workflows/audit-workflow/workflow.yaml</critical>
  ...
  <step n="5" goal="Web bundle validation" optional="true">
    <check if="workflow.yaml contains web_bundle section">
      ...
      **Path Validation:**
      ...
      - [ ] All paths use .osx/-relative format (NOT {project-root})
      ...
      **Workflow Dependency Scan:**
      ...
      <action>Example: If instructions use {core_brainstorming}, web_bundle needs: existing_workflows: - core_brainstorming: ".osx/core/workflows/brainstorming/workflow.yaml"</action>
