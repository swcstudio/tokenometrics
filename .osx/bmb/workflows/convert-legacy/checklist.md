...
- [ ] ALL paths reference {project-root}/.osx/{{module}}/ locations, NOT src/
...
- [ ] Elicitation points (elicit: true) converted to <invoke-task halt="true">{project-root}/.osx/core/tasks/adv-elicit.xml</invoke-task>
