...
<critical>You MUST have already loaded and processed: {project-root}/.osx/bmb/workflows/edit-workflow/workflow.yaml</critical>
...
- Study example workflows from: {project-root}/.osx/bmm/workflows/
  </action>
