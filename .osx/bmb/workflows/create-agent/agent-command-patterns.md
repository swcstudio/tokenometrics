...
<!-- Standard workflow -->
<item cmd="*create-prd"
     run-workflow="{project-root}/.osx/bmm/workflows/prd/workflow.yaml">
...
<item cmd="*validate-prd"
     ...
     workflow="{project-root}/.osx/bmm/workflows/prd/workflow.yaml">
...
<!-- Simple task -->
<item cmd="*validate"
   exec="{project-root}/.osx/core/tasks/validate-workflow.xml">
  Validate document against checklist
</item>

<!-- Task with data -->
<item cmd="*standup"
   exec="{project-root}/.osx/mmm/tasks/daily-standup.xml"
   data="{project-root}/.osx/_cfg/agent-manifest.csv">
...
```xml
<item cmd="*brief"
   exec="{project-root}/.osx/core/tasks/create-doc.md"
   tmpl="{project-root}/.osx/bmm/templates/brief.md">
  Produce Project Brief
</item>

<item cmd="*competitor-analysis"
   exec="{project-root}/.osx/core/tasks/create-doc.md"
   tmpl="{project-root}/.osx/bmm/templates/competitor.md"
   data="{project-root}/.osx/_data/market-research.csv">
...
<item cmd="*list-tasks"
   action="list all tasks from {project-root}/.osx/_cfg/task-manifest.csv">
...
<agent name="Research Assistant">
  ...
  <menu>
    ...
    <item cmd="*review-literature"
       ...
       data="{project-root}/.osx/_data/sources.csv">
...
<!-- Workflow with data -->
<item cmd="*brainstorm"
   run-workflow="{project-root}/.osx/core/workflows/brainstorming/workflow.yaml"
   data="{project-root}/.osx/core/workflows/brainstorming/brain-methods.csv">
...
<item cmd="*analyze-metrics"
   ...
   data="{project-root}/.osx/_data/performance-metrics.json">
...
<item cmd="*report"
   exec="{project-root}/.osx/core/tasks/create-doc.md"
   tmpl="{project-root}/.osx/bmm/templates/report.md"
   data="{project-root}/.osx/_data/quarterly-results.csv">
...
<item cmd="*{action}-{object}"
   run-workflow="{project-root}/.osx/{module}/workflows/{workflow}/workflow.yaml">
...
<item cmd="*validate-{object}"
   validate-workflow="{output_folder}/{document}.md"
   workflow="{project-root}/.osx/{module}/workflows/{workflow}/workflow.yaml">
...
```xml
<item cmd="*{action}"
   exec="{project-root}/.osx/{module}/tasks/{task}.md">
  {Action Description}
</item>
```
...
<item cmd="*{document}"
   exec="{project-root}/.osx/core/tasks/create-doc.md"
   tmpl="{project-root}/.osx/{module}/templates/{template}.md">
...
```xml
<agent id=".osx/research/agents/analyst.md" name="Research Analyst" icon="🔬">
  ...
  <menu>
    ...
    <item cmd="*compete"
       ...
       data="{project-root}/.osx/_data/market-data.csv">
      Analyze Competition
    </item>
    ...
    <item cmd="*report"
       exec="{project-root}/.osx/core/tasks/create-doc.md"
       tmpl="{project-root}/.osx/research/templates/report.md">
...
<agent name="Data Analyst">
  <menu>
    ...
    <item cmd="*analyze"
       ...
       data="{project-root}/.osx/_data/dataset.csv">
      Analyze Dataset
    </item>
