...
- Source: `.osx/agents/{filename}.agent.yaml`
- Compiled: `.osx/agents/{filename}.md`

**Module Agents:**

- Source: `src/modules/{module}/agents/{filename}.agent.yaml`
- Compiled: `.osx/{module}/agents/{filename}.md`
...
agent:
  metadata:
    id: .osx/{module}/agents/{filename}.md
    name: Agent Name
    title: Agent Title
    icon: 🤖
    module: module-name
...
Location: `.osx/_cfg/agents/{module}-{filename}.customize.yaml`
