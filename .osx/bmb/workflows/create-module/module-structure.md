...
menu:
  - trigger: command-name
    workflow: '{project-root}/.osx/SOURCE_MODULE/workflows/path/workflow.yaml'
    workflow-install: '{project-root}/.osx/THIS_MODULE/workflows/vendored/workflow.yaml'
...
data_path:
  result: '{project-root}/.osx/module-code/data'
```
