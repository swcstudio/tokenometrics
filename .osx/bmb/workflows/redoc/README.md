...
- **Module path**: `.osx/bmm` (documents entire module: root, workflows, agents)
- **Workflows folder**: `.osx/bmm/workflows` (documents all workflows)
- **Agents folder**: `.osx/bmm/agents` (documents all agents)
- **Single workflow**: `.osx/bmm/workflows/product-brief` (documents one workflow)
- **Single agent**: `.osx/bmm/agents/prd-agent.md` (documents one agent)
