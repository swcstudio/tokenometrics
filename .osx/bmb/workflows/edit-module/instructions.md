...
<critical>You MUST have already loaded and processed: {project-root}/.osx/bmb/workflows/edit-module/workflow.yaml</critical>
...
<ask>What is the path to the module you want to edit? (provide path to module directory like .osx/bmm/ or src/modules/bmm/)</ask>
...
- Show how to reference workflows properly: {project-root}/.osx/{{module}}/workflows/{{workflow}}/workflow.yaml
