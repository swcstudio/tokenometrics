...
<task id=".osx/core/tasks/adv-elicit.xml" name="Advanced Elicitation" standalone="true"
  methods="{project-root}/.osx/core/tasks/adv-elicit-methods.csv"
  agent-party="{project-root}/.osx/_cfg/agent-manifest.csv">
  <llm critical="true">
