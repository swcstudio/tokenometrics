...
installed_path: "{project-root}/.osx/bmb/workflows/create-agent"
...
# Module agents: Save to .osx/{{target_module}}/agents/
# Standalone agents: Save to custom_agent_location/
module_output_file: "{project-root}/.osx/{{target_module}}/agents/{{agent_filename}}.agent.yaml"
...
config_output_file: "{project-root}/.osx/_cfg/agents/{{target_module}}-{{agent_filename}}.customize.yaml"
