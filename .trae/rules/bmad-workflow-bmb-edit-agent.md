...
agent_types: "{project-root}/.osx/bmb/workflows/create-agent/agent-types.md"
agent_architecture: "{project-root}/.osx/bmb/workflows/create-agent/agent-architecture.md"
agent_commands: "{project-root}/.osx/bmb/workflows/create-agent/agent-command-patterns.md"
communication_styles: "{project-root}/.osx/bmb/workflows/create-agent/communication-styles.md"
...
recommended_inputs:
  ...
  - example_agents: "{project-root}/.osx/bmm/agents/"
  - agent_activation_rules: "{project-root}/src/utility/models/agent-activation-ide.xml"

# Module path and component files
installed_path: "{project-root}/.osx/bmb/workflows/edit-agent"
